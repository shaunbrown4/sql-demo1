...
SELECT host_id, host_name FROM final_airbnb
Where host_id = "63613";
...
SELECT number_of_reviews FROM final_airbnb
...
SELECT room_type, number_of_reviews, id FROM final_airbnb
...
-- EXPECTED OUTPUT: 58059
SELECT reviews_per_month, id From final_airbnb
...
--What makes a  successfull airbnb in this makret is the neighbourhood, host, room type and number of reviews  
